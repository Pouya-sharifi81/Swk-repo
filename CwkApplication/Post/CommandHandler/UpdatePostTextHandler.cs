...
{
    public class UpdatePostTextHandler : IRequestHandler<UpdatePostText, OperationResault<PostModel>>
    {
        ...
        public async Task<OperationResault<PostModel>> Handle(UpdatePostText request, CancellationToken cancellationToken)
        {
